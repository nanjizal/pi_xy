...
HX_DEFINE_STACK_FRAME(_hx_pos_bb72131a12eaee86_30_new,"haxe.zip.Compress","new",0x4ddc50a9,"haxe.zip.Compress.new","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/zip/Compress.hx",30,0x96937b70)
HX_LOCAL_STACK_FRAME(_hx_pos_bb72131a12eaee86_34_execute,"haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/zip/Compress.hx",34,0x96937b70)
HX_LOCAL_STACK_FRAME(_hx_pos_bb72131a12eaee86_38_setFlushMode,"haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/zip/Compress.hx",38,0x96937b70)
HX_LOCAL_STACK_FRAME(_hx_pos_bb72131a12eaee86_42_close,"haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/zip/Compress.hx",42,0x96937b70)
HX_LOCAL_STACK_FRAME(_hx_pos_bb72131a12eaee86_45_run,"haxe.zip.Compress","run",0x4ddf6794,"haxe.zip.Compress.run","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/zip/Compress.hx",45,0x96937b70)
namespace haxe{
namespace zip{

void Compress_obj::__construct(int level){
            	HX_STACKFRAME(&_hx_pos_bb72131a12eaee86_30_new)
...
bool Compress_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos, ::haxe::io::Bytes dst,int dstPos){
            	HX_STACKFRAME(&_hx_pos_bb72131a12eaee86_34_execute)
...
void Compress_obj::setFlushMode( ::haxe::zip::FlushMode f){
            	HX_STACKFRAME(&_hx_pos_bb72131a12eaee86_38_setFlushMode)
...
void Compress_obj::close(){
            	HX_STACKFRAME(&_hx_pos_bb72131a12eaee86_42_close)
...
HX_DEFINE_DYNAMIC_FUNC0(Compress_obj,close,(void))
 ...
 ::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
            	HX_GC_STACKFRAME(&_hx_pos_bb72131a12eaee86_45_run)
