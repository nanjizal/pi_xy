...
abstract Pixelshape( Pixelimage ) to Pixelimage {
	...
	**/
	...
	function fillRoundRect( x: Float, y: Float
		...
		fillRoundRectangle( abstract, x, y
			              , wid, hi
						  , color
						  , dx, dy
						  , fat, tall );
	...
	**/
	...
	public inline
	function fillCircle( cx: Float, cy: Float
					   , r: Float
					   , color: Int
					   , ?phi: Float = 0. ){
		fillEllipseTri( cx, cy
			          , r, r
					  , color
					  , phi );
	}
	...
	@:access(pixelimage.Pixelimage.fillEllipseTri)
	public inline
	function fillEllipse( cx: Float, cy: Float
						, rx: Float, ry: Float
						, color: Int
						, ?phi: Float = 0. ){
		fillEllipseTri( cx, cy
	...
	public inline
	function fillArrowHead( cx: Float, cy: Float
		                  , rx: Float, ry: Float
						  , color: Int
						  , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillPentagon( cx: Float, cy: Float
		                 , rx: Float, ry: Float
						 , color: Int
						 , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillHexagon( cx: Float, cy: Float
		                , rx: Float, ry: Float
						, color: Int
						, ?phi:Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillHeptagon( cx: Float, cy: Float
						 , rx: Float, ry: Float
						 , color: Int
						 , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillSeptagon( cx: Float, cy: Float
		                 , rx: Float, ry: Float
						 , color: Int
						 , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillOctagon( cx: Float, cy: Float
		                , rx: Float, ry: Float
						, color: Int
						, ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillNonagon( cx: Float, cy: Float
		                , rx: Float, ry: Float
						, color: Int
						, ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillEnneagon( cx: Float, cy: Float
		                 , rx: Float, ry: Float
						 , color: Int
						 , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillDecagon( cx: Float, cy: Float
		                , rx: Float, ry: Float
						, color: Int
						, ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillHendecagon( cx: Float, cy: Float
						   , rx: Float, ry: Float
						   , color: Int
						   , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillUndecagon( cx: Float, cy: Float
						  , rx: Float, ry: Float
						  , color: Int
						  , ?phi: Float = 0. ){
		fillPolyBuild( cx, cy
	...
	public inline
	function fillDodecagon( cx: Float, cy: Float
						  , rx: Float, ry: Float
						  , color: Int
						  , ?phi: Float = 0. ) {
		fillPolyBuild( cx, cy
	...
	public inline
	function fillSoftQuad( ax: Float, ay: Float
		                 , bx: Float, by: Float
						 , cx: Float, cy: Float
						 , dx: Float, dy: Float
						 , color: Int
	...
	public inline
	function fillSoftLine( px: Float, py: Float
						 , qx: Float, qy: Float
						 , thick: Float
						 , color: Int
						 , soft: Float = 40
	...
	public inline
	function fillSoftLineLuxury( px: Float, py: Float
		                       , qx: Float, qy: Float
							   , thick: Float
							   , color: Int
							   , soft: Float = 40
	...
	public inline
	function sweepGradTri( ax: Float, ay: Float
						 , rx: Float, ry: Float
						 , startRadian: Float, sweepRadian: Float
	...
	**/
	public inline
	function imgQuadFudge( texture: Pixelimage
						 , win: RectangleWindow
						 , ax: Float, ay: Float
						 , bx: Float, by: Float
						 , cx: Float, cy: Float
	...
	public inline
	function imgRectFudge( texture: Pixelimage
						 , win: RectangleWindow
						 , x: Float, y: Float
						 , wid: Float, hi: Float
						 , theta: Float = 0.
	...
	**/
	public inline
	function fillArrow( px: Float, py: Float
					  , qx: Float, qy: Float
					  , thick: Float, color: Int
	...
	public inline
	function fillArrowBoth( px: Float, py: Float
						  , qx: Float, qy: Float
						  , thick: Float, color: Int
						  , hasHit: Bool = true ): Null<HitTriArray> {
	...
	public inline
	function fillFixArrow( px: Float, py: Float
						 , qx: Float, qy: Float
	...
	public inline
	function fillFixArrowBoth( px: Float, py: Float
		                     , qx: Float, qy: Float
							 , arrowWidth: Float, arrowHeight: Float
							 , thick: Float
							 , color: Int
	...
	public inline
	function fillSoftArrow( px: Float, py: Float
						  , qx: Float, qy: Float
						  , thick: Float
						  , color: Int
						  , flare: Bool = false
	...
	public inline
	function fillSoftArrowBoth( px: Float, py: Float
							  , qx: Float, qy: Float
							  , thick: Float, color: Int
	...
	public inline
	function fillSoftFixArrow( px: Float, py: Float
		                     , qx: Float, qy: Float
							 , arrowWidth: Float, arrowHeight: Float
							 , thick: Float
							 , color: Int
	...
	public inline
	function fillSoftFixArrowBoth( px: Float, py: Float
								 , qx: Float, qy: Float
								 , arrowWidth: Float, arrowHeight: Float
								 , thick: Float
								 , color: Int
	...
	public inline
	function gradThickArrow( px: Float, py: Float
						   , qx: Float, qy: Float
						   , thick: Float
						   , color1: Int
						   , color2: Int
	...
	public inline
	function gradThickArrowBoth( px: Float, py: Float
							   , qx: Float, qy: Float
							   , thick: Float
	...
	public inline
	function gradThickFixArrow( px: Float, py: Float
							  , qx: Float, qy: Float
							  , arrowWidth: Float, arrowHeight: Float
					          , thick: Float
							  , color1: Int, color2: Int
	...
	public inline
	function gradThickFixArrowBoth( px: Float, py: Float
								  , qx: Float, qy: Float
								  , arrowWidth: Float, arrowHeight: Float
								  , thick: Float
								  , color1: Int, color2: Int
	...
	**/
	...
	function lineEllipseTri( cx: Float, cy: Float
		...
		if (phi == 0) {
			...
			temp.fillPolyBuild( rx + rDif, ry + rDif
							  , rx2, ry2
							  , 0x00000000
							  , phi
							  , noSides );
	...
	**/
	...
	function fillRadialRectangle( x: Float, y: Float
		...
		temp.fillRadialEllipseTri( rx, ry
								 , rx, ry
								 , colorIn, colorOut
								 , gx, gy );
		this.putPixelImage( temp, Std.int( x ), Std.int( y ) );
