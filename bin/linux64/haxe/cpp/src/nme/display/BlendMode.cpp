...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("nme.display.BlendMode",e0,ab,c4,aa), ::hx::TCanCast< BlendMode_obj >,BlendMode_obj_sStaticFields,0,
...
{
ADD = ::hx::CreateConstEnum< BlendMode_obj >(HX_("ADD",01,8e,31,00),7);
ALPHA = ::hx::CreateConstEnum< BlendMode_obj >(HX_("ALPHA",3e,df,84,9f),10);
DARKEN = ::hx::CreateConstEnum< BlendMode_obj >(HX_("DARKEN",5f,e2,bc,d3),5);
DIFFERENCE = ::hx::CreateConstEnum< BlendMode_obj >(HX_("DIFFERENCE",fd,0f,9b,38),6);
ERASE = ::hx::CreateConstEnum< BlendMode_obj >(HX_("ERASE",c6,20,0b,f1),11);
HARDLIGHT = ::hx::CreateConstEnum< BlendMode_obj >(HX_("HARDLIGHT",eb,dd,c3,4e),13);
INVERT = ::hx::CreateConstEnum< BlendMode_obj >(HX_("INVERT",16,93,5b,52),9);
LAYER = ::hx::CreateConstEnum< BlendMode_obj >(HX_("LAYER",b1,b9,ae,ed),1);
LIGHTEN = ::hx::CreateConstEnum< BlendMode_obj >(HX_("LIGHTEN",9f,1e,b7,99),4);
MULTIPLY = ::hx::CreateConstEnum< BlendMode_obj >(HX_("MULTIPLY",24,72,12,f4),2);
NORMAL = ::hx::CreateConstEnum< BlendMode_obj >(HX_("NORMAL",27,1e,ec,e2),0);
OVERLAY = ::hx::CreateConstEnum< BlendMode_obj >(HX_("OVERLAY",70,17,e4,28),12);
SCREEN = ::hx::CreateConstEnum< BlendMode_obj >(HX_("SCREEN",6c,e7,df,f9),3);
SUBTRACT = ::hx::CreateConstEnum< BlendMode_obj >(HX_("SUBTRACT",14,05,97,51),8);
}
