...
HX_DEFINE_STACK_FRAME(_hx_pos_9b931b744f84d4a8_16_new,"nme.media.ID3Info","new",0xb5aa46c6,"nme.media.ID3Info.new","nme/media/ID3Info.hx",16,0x607970ac)
namespace nme{
namespace media{
...
bool ID3Info_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x28e88fa8;
}
...
void ID3Info_obj::__register()
{
	...
	__mClass->mName = HX_("nme.media.ID3Info",d4,2b,0a,7e);
