...
class HXCPP_CLASS_ATTRIBUTES Vector_Impl__obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x716a1fff };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="nme._Vector.Vector_Impl_")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"nme._Vector.Vector_Impl_"); }
		...
		inline static ::hx::ObjectPtr< Vector_Impl__obj > __alloc(::hx::Ctx *_hx_ctx) {
			Vector_Impl__obj *__this = (Vector_Impl__obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Vector_Impl__obj), false, "nme._Vector.Vector_Impl_"));
		...
		static void insertAt(::cpp::VirtualArray this1,int index, ::Dynamic element);
		...
		static ::cpp::VirtualArray fromArray(::cpp::VirtualArray a);
