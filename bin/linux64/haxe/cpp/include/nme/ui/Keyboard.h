...
#define INCLUDED_nme_ui_Keyboard

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS2(nme,ui,Keyboard)
...
class HXCPP_CLASS_ATTRIBUTES Keyboard_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x7fc69aad };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="nme.ui.Keyboard")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"nme.ui.Keyboard"); }
		...
		inline static ::hx::ObjectPtr< Keyboard_obj > __alloc(::hx::Ctx *_hx_ctx) {
			Keyboard_obj *__this = (Keyboard_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Keyboard_obj), false, "nme.ui.Keyboard"));
...
#endif /* INCLUDED_nme_ui_Keyboard */ 
