...
HX_DEFINE_STACK_FRAME(_hx_pos_e7dcd1e91cd0b518_44_new,"haxe.xml.Printer","new",0x896dce4d,"haxe.xml.Printer.new","/home/nanjizalmac/haxe/versions/4.3.3/std/haxe/xml/Printer.hx",44,0x9538f531)
HX_LOCAL_STACK_FRAME(_hx_pos_e7dcd1e91cd0b518_50_writeNode,"haxe.xml.Printer","writeNode",0x6952ac2e,"haxe.xml.Printer.writeNode","/home/nanjizalmac/haxe/versions/4.3.3/std/haxe/xml/Printer.hx",50,0x9538f531)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e7dcd1e91cd0b518_114_hasChildren,"haxe.xml.Printer","hasChildren",0xeb7e31a6,"haxe.xml.Printer.hasChildren","/home/nanjizalmac/haxe/versions/4.3.3/std/haxe/xml/Printer.hx",114,0x9538f531)
HX_LOCAL_STACK_FRAME(_hx_pos_e7dcd1e91cd0b518_35_print,"haxe.xml.Printer","print",0x4a926b5a,"haxe.xml.Printer.print","/home/nanjizalmac/haxe/versions/4.3.3/std/haxe/xml/Printer.hx",35,0x9538f531)
namespace haxe{
namespace xml{

void Printer_obj::__construct(bool pretty){
            	HX_GC_STACKFRAME(&_hx_pos_e7dcd1e91cd0b518_44_new)
...
void Printer_obj::writeNode( ::Xml value,::String tabs){
            	HX_GC_STACKFRAME(&_hx_pos_e7dcd1e91cd0b518_50_writeNode)
...
bool Printer_obj::hasChildren( ::Xml value){
            	HX_STACKFRAME(&_hx_pos_e7dcd1e91cd0b518_114_hasChildren)
HXLINE( 115)		{
...
::String Printer_obj::print( ::Xml xml, ::Dynamic __o_pretty){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_e7dcd1e91cd0b518_35_print)
