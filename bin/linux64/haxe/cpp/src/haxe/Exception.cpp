...
HX_DEFINE_STACK_FRAME(_hx_pos_0b0e7391dd9abd7a_5_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/Exception.hx",5,0x00e4a60d)
HX_LOCAL_STACK_FRAME(_hx_pos_0b0e7391dd9abd7a_56_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/Exception.hx",56,0x00e4a60d)
HX_LOCAL_STACK_FRAME(_hx_pos_0b0e7391dd9abd7a_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/Exception.hx",76,0x00e4a60d)
HX_LOCAL_STACK_FRAME(_hx_pos_0b0e7391dd9abd7a_19_caught,"haxe.Exception","caught",0xbc294f23,"haxe.Exception.caught","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/haxe/Exception.hx",19,0x00e4a60d)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_0b0e7391dd9abd7a_5_new)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_0b0e7391dd9abd7a_56_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_0b0e7391dd9abd7a_76_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::caught( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_0b0e7391dd9abd7a_19_caught)
