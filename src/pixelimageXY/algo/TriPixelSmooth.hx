...
function triPentagonBarycentic( pixelImage: Pixelimage
    ...
    var dot12 = dot( bcx, bcy, acx, acy );  // <- for details see pixelimageXY.algo.GeomPix
    ...
    var yIter3: IteratorRange = boundIterator3( ay, by, cy );  // <- for details see pixelimageXY.iter.*
