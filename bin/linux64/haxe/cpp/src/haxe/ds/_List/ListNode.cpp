...
HX_DEFINE_STACK_FRAME(_hx_pos_715a0960b32f14eb_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/home/nanjizalmac/haxe/versions/4.3.3/std/haxe/ds/List.hx",266,0x57a71c35)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_715a0960b32f14eb_266_new)
