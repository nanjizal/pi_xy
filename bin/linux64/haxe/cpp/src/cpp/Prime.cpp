...
HX_LOCAL_STACK_FRAME(_hx_pos_0628bb931fac33bd_34__loadPrime,"cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/Prime.hx",34,0x63f9fcbf)
namespace cpp{
...
bool Prime_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Prime_obj::_loadPrime(::String lib,::String prim,::String signature,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_STACKFRAME(&_hx_pos_0628bb931fac33bd_34__loadPrime)
