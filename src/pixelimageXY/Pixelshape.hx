...
// soft ones
    public inline
    function fillSoftArrow( px: Float, py: Float, qx: Float, qy: Float
        , thick: Float, color: Int, flare: Bool = false, reverseFlare: Bool = false, soft: Float = 40., hasHit: Bool = true ): Null<HitTriArray> {
        return fillSoftLineArrow( this, px, py, qx, qy, thick, color, flare, reverseFlare, soft, hasHit );
    }
    public inline
    function fillSoftArrowBoth( px: Float, py: Float, qx: Float, qy: Float
        , thick: Float, color: Int, soft: Float = 40., hasHit: Bool = true ): Null<HitTriArray> {
        return fillSoftLineArrowBoth( this, px, py, qx, qy, thick, color, soft, hasHit );
    }
    public inline
    function fillSoftFixArrow( px: Float, py: Float, qx: Float, qy: Float, arrowWidth: Float, arrowHeight: Float
        , thick: Float, color: Int, flare: Bool = false, reverseFlare: Bool = false, soft: Float = 40., hasHit: Bool = true ): Null<HitTriArray> {
        return fillSoftLineFixedArrow( this, px, py, qx, qy, arrowWidth, arrowHeight, thick, color, flare, reverseFlare, soft, hasHit );
    }
    public inline
    function fillSoftFixArrowBoth( px: Float, py: Float, qx: Float, qy: Float, arrowWidth: Float, arrowHeight: Float
        , thick: Float, color: Int, soft: Float = 40., hasHit: Bool = true ): Null<HitTriArray> {
