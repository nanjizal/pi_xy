...
HX_DEFINE_STACK_FRAME(_hx_pos_f366fe84c1f597f7_31_new,"sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/sys/io/Process.hx",31,0x5817b42b)
HX_LOCAL_STACK_FRAME(_hx_pos_f366fe84c1f597f7_41_writeByte,"sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/sys/io/Process.hx",41,0x5817b42b)
HX_LOCAL_STACK_FRAME(_hx_pos_f366fe84c1f597f7_47_writeBytes,"sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","/home/nanjizalmac/haxe/versions/4.3.3/std/cpp/_std/sys/io/Process.hx",47,0x5817b42b)
namespace sys{
namespace io{
namespace _Process{

void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACKFRAME(&_hx_pos_f366fe84c1f597f7_31_new)
HXLINE(  32)		this->p = p;
...
void Stdin_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_f366fe84c1f597f7_41_writeByte)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_f366fe84c1f597f7_47_writeBytes)
HXDLIN(  47)		try {
