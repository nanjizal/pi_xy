...
abstract Pixelshape(Pixelimage) to Pixelimage {
	 ...
	 */
	public inline function lineGrid(x:Float, y:Float, w:Float, h:Float, delta:Float, thick:Float, color:Int) {
	...
	public inline function lineGridWH(x:Float, y:Float, w:Float, h:Float, deltaW:Float, deltaH:Float, thick:Float, color:Int) {
	...
	**/
	public inline function fillRoundRect(x:Float, y:Float, hi:Float, wid:Float, color:Int, ?dx:Float = -1., ?dy:Float = -1., ?fat:Float = -1.,
			?tall:Float = -1.) {
		fillRoundRectangle(abstract, x, y, wid, hi, color, dx, dy, fat, tall);
	}

	public inline function lineRoundRect(x:Float, y:Float, hi:Float, wid:Float, thick:Float, color:Int, ?dx:Float = -1., ?dy:Float = -1., ?fat:Float = -1.,
			?tall:Float = -1.) {
	...
	/**
		...
		fat, tall - the inner dimensions of the 9-slice centre, optional
	**/
	public inline function fillGrad4RoundRect(x:Float, y:Float, hi:Float, wid:Float, colorA:Pixel32, colorB:Pixel32, colorC:Pixel32, colorD:Pixel32,
			?dx:Float = -1., ?dy:Float = -1., ?fat:Float = -1., ?tall:Float = -1.) {
		fillGrad4RoundRectangle(abstract, x, y, hi, wid, colorA, colorC, colorB, colorD, dx, dy, fat, tall);
	}

	public inline function lineGrad4RoundRect(x:Float, y:Float, hi:Float, wid:Float, thick:Float, colorA:Pixel32, colorB:Pixel32, colorC:Pixel32,
			colorD:Pixel32, ?dx:Float = -1., ?dy:Float = -1., ?fat:Float = -1., ?tall:Float = -1.) {
	...
	public inline function testFillSimonSaysQuadrant(cx:Float, cy:Float, radius:Float) {
	...
	public inline function fillQuadrantI(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0.) {
		// positive positive plane I  + + , simon says RED
		fillQuadrant(cx, cy, rx, ry, 3 * Math.PI / 2, color, phi);
	}

	public inline function tileQuadrantI(cx:Float, cy:Float, rx:Float, ry:Float, tileImage:Pixelimage, ?phi:Float = 0.) {
		// positive positive plane I  + + , simon says RED
		tileQuadrant(cx, cy, rx, ry, 3 * Math.PI / 2, tileImage, phi);
	}

	public inline function fillQuadrantII(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0.) {
		// plane II  - + , simon says GREEN
		fillQuadrant(cx, cy, rx, ry, Math.PI, color, phi);
	}

	public inline function tileQuadrantII(cx:Float, cy:Float, rx:Float, ry:Float, tileImage:Pixelimage, ?phi:Float = 0.) {
		// plane II  - + , simon says GREEN
		tileQuadrant(cx, cy, rx, ry, Math.PI, tileImage, phi);
	}

	public inline function fillQuadrantIII(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0.) {
		// negative negative plane III - - , simon says YELLOW
		fillQuadrant(cx, cy, rx, ry, Math.PI / 2, color, phi);
	}

	public inline function tileQuadrantIII(cx:Float, cy:Float, rx:Float, ry:Float, tileImage:Pixelimage, ?phi:Float = 0.) {
		// negative negative plane III - - , simon says YELLOW
		tileQuadrant(cx, cy, rx, ry, Math.PI / 2, tileImage, phi);
	}

	public inline function fillQuadrantIV(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0.) {
		// plane IV  + - , simon says BLUE
		fillQuadrant(cx, cy, rx, ry, 0, color, phi);
	}

	public inline function tileQuadrantIV(cx:Float, cy:Float, rx:Float, ry:Float, tileImage:Pixelimage, ?phi:Float = 0.) {
		// plane IV  + - , simon says BLUE
		tileQuadrant(cx, cy, rx, ry, 0, tileImage, phi);
	}

	@:access(pixelimage.Pixelimage.fillEllipseTri)
	public inline function fillCircle(cx:Float, cy:Float, r:Float, color:Int, ?phi:Float = 0) {
		fillEllipseTri(cx, cy, r, r, color, phi);
	}

	@:access(pixelimage.Pixelimage.fillEllipseTri)
	public inline function fillEllipse(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillEllipseTri(cx, cy, rx, ry, color, phi);
	}

	public inline function fillArrowHead(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 3, false);
	}

	public inline function fillPentagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 5, false);
	}

	public inline function fillHexagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 6, false);
	}

	public inline function fillHeptagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 7, false);
	}

	public inline function fillSeptagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 7, false);
	}

	public inline function fillOctagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 8, false);
	}

	public inline function fillNonagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 9, false);
	}

	public inline function fillEnneagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 9, false);
	}

	public inline function fillDecagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 10, false);
	}

	public inline function fillHendecagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 11, false);
	}

	public inline function fillUndecagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 11, false);
	}

	public inline function fillDodecagon(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0) {
		fillPolyBuild(cx, cy, rx, ry, color, phi, 12, false);
	}

	public inline function softFillQuint(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, dx:Float, dy:Float, color:Int, softC:Float,
	...
	public inline function fillSoftQuad(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, dx:Float, dy:Float, color:Int, soft:Float = 40,
			softAB:Bool = true, softBC:Bool = true, softCD:Bool = true, softDA:Bool = true, hasHit:Bool = false):HitQuad {
		// tri e - a b d
		// tri f - b c d
		return fillSoftQuadrilateral(this, ax, ay, bx, by, cx, cy, dx, dy, color, soft, softAB, softBC, softCD, softDA, hasHit);
	}

	public inline function fillSoftQuadFudge(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, dx:Float, dy:Float, color:Int, soft:Float = 40,
			softAB:Bool = true, softBC:Bool = true, softCD:Bool = true, softDA:Bool = true, hasHit:Bool = false):HitQuad {
		return fillSoftQuadrilateralFudge(this, ax, ay, bx, by, cx, cy, dx, dy, color, soft, softAB, softBC, softCD, softDA, hasHit);
	}

	public inline function fillSoftQuadQuarter(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, dx:Float, dy:Float, color:Int, soft:Float = 40,
			softAB:Bool = true, softBC:Bool = true, softCD:Bool = true, softDA:Bool = true, hasHit:Bool = false):HitQuad {
		return fillSoftQuadrilateralQuarter(this, ax, ay, bx, by, cx, cy, dx, dy, color, soft, softAB, softBC, softCD, softDA, hasHit);
	}

	public inline function fillSoftLine(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color:Int, soft:Float = 40, softAB:Bool = true,
			softBC:Bool = true, softCD:Bool = true, softDA:Bool = true, hasHit:Bool = true, ?debugCorners = false):Null<HitQuad> {
		var o = qy - py;
		var a = qx - px;
	...
	public inline function fillSoftLineLuxury(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color:Int, soft:Float = 40, softAB:Bool = true,
			softBC:Bool = true, softCD:Bool = true, softDA:Bool = true, hasHit:Bool = true, ?debugCorners = false):Null<HitQuad> {
		var o = qy - py;
		var a = qx - px;
		var h = Math.pow(o * o + a * a, 0.5);
	...
	public inline function softFillTriangle(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, color:Int, soft3:Float, softAB:Bool = true,
			softBC:Bool = true, softCA:Bool = true, hasHit:Bool = false):HitTri {
		/* debug
			this.fillSquare( ax, ay, 12, 0xFF0000ff );
			this.fillSquare( bx, by, 12, 0xFFF000F0 );
			this.fillSquare( cx, cy, 12, 0xFFF0F000 );
		 */
		return fillTriSoft3(this, ax, ay, bx, by, cx, cy, color, soft3, softAB, softBC, softCA, hasHit);
	}

	public inline function sweepTri(ax:Float, ay:Float, rx:Float, ry:Float, startRadian:Float, sweepRadian:Float, color:Pixel32,
	...
	public inline function tileSweepTri(ax:Float, ay:Float, rx:Float, ry:Float, startRadian:Float, sweepRadian:Float, tileImage:Pixelimage,
	...
	public inline function fillPie(ax:Float, ay:Float, rx:Float, ry:Float, startRadian:Float, sweepRadian:Float, color:Pixel32, hasHit:Bool = false,
	...
	public inline function tilePie(ax:Float, ay:Float, rx:Float, ry:Float, startRadian:Float, sweepRadian:Float, tileImage:Pixelimage, hasHit:Bool = false,
			?targetError:Float = 1.05):Null<HitTriArray> {
		var rSmall = (rx > ry) ? ry : rx;
		var noSides = circleError(rSmall, targetError);
		var theta = 1.41213 * Math.PI / noSides; // 2* but make smaller
	...
	public inline function sweepGradTri(ax:Float, ay:Float, rx:Float, ry:Float, startRadian:Float, sweepRadian:Float, colA:Pixel32, colB:Pixel32,
			colC:Pixel32, hasHit:Bool = false):Null<HitTri> {
		var currAngle = startRadian;
		var bx = rx * Math.cos(currAngle) + ax;
		var by = ry * Math.sin(currAngle) + ay;
		// last pie
	...
	public inline function fillRadialPie(ax:Float, ay:Float, rx:Float, ry:Float, startRadian:Float, sweepRadian:Float, centreColor:Pixel32,
			outerColor:Pixel32, hasHit:Bool = false, ?targetError:Float = 1.05):Null<HitTriArray> {
		var rSmall = (rx > ry) ? ry : rx;
		var noSides = circleError(rSmall, targetError);
	...
	**/
	public inline function imgQuadFudge(texture:Pixelimage, win:RectangleWindow, ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, dx:Float,
			dy:Float, hasHit:Bool = true):Null<HitQuad> {
		return imgQuadrilateralFudge(this, texture, win, ax, ay, bx, by, cx, cy, dx, dy, hasHit);
	}

	public inline function imgRectFudge(texture:Pixelimage, win:RectangleWindow, x:Float, y:Float, wid:Float, hi:Float, theta:Float = 0., centreX:Float = 0.,
			centreY:Float = 0., skewX:Float = 0., skewY:Float = 0., hasHit:Bool = true):Null<HitQuad> {
		var ax = x;
		var ay = y;
		if (theta != 0.) {
	...
	**/
	public inline function fillArrow(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color:Int, flare:Bool = false, reverseFlare:Bool = false,
			hasHit:Bool = true):Null<HitTriArray> {
		return fillLineArrow(this, px, py, qx, qy, thick, color, flare, reverseFlare, hasHit);
	}

	public inline function fillArrowBoth(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color:Int, hasHit:Bool = true):Null<HitTriArray> {
		return fillLineArrowBoth(this, px, py, qx, qy, thick, color, hasHit);
	}

	public inline function fillFixArrow(px:Float, py:Float, qx:Float, qy:Float, arrowWidth:Float, arrowHeight:Float, thick:Float, color:Int,
			flare:Bool = false, reverseFlare:Bool = false, hasHit:Bool = true):Null<HitTriArray> {
	...
	public inline function fillFixArrowBoth(px:Float, py:Float, qx:Float, qy:Float, arrowWidth:Float, arrowHeight:Float, thick:Float, color:Int,
			hasHit:Bool = true):Null<HitTriArray> {
	...
	public inline function fillSoftArrow(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color:Int, flare:Bool = false, reverseFlare:Bool = false,
			soft:Float = 40., hasHit:Bool = true):Null<HitTriArray> {
		return fillSoftLineArrow(this, px, py, qx, qy, thick, color, flare, reverseFlare, soft, hasHit);
	}

	public inline function fillSoftArrowBoth(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color:Int, soft:Float = 40.,
			hasHit:Bool = true):Null<HitTriArray> {
		return fillSoftLineArrowBoth(this, px, py, qx, qy, thick, color, soft, hasHit);
	}

	public inline function fillSoftFixArrow(px:Float, py:Float, qx:Float, qy:Float, arrowWidth:Float, arrowHeight:Float, thick:Float, color:Int,
			flare:Bool = false, reverseFlare:Bool = false, soft:Float = 40., hasHit:Bool = true):Null<HitTriArray> {
		return fillSoftLineFixedArrow(this, px, py, qx, qy, arrowWidth, arrowHeight, thick, color, flare, reverseFlare, soft, hasHit);
	}

	public inline function fillSoftFixArrowBoth(px:Float, py:Float, qx:Float, qy:Float, arrowWidth:Float, arrowHeight:Float, thick:Float, color:Int,
			soft:Float = 40., hasHit:Bool = true):Null<HitTriArray> {
		return fillSoftLineFixedArrowBoth(this, px, py, qx, qy, arrowWidth, arrowHeight, thick, color, soft, hasHit);
	}

	// gradient thick arrows

	public inline function gradThickArrow(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color1:Int, color2:Int, flare:Bool = false, reverseFlare:Bool,
			hasHit:Bool = true):Null<HitTriArray> {
		return gradThickLineArrow(this, px, py, qx, qy, thick, color1, color2, flare, reverseFlare, hasHit);
	}

	public inline function gradThickArrowBoth(px:Float, py:Float, qx:Float, qy:Float, thick:Float, color1:Int, color2:Int,
			hasHit:Bool = true):Null<HitTriArray> {
		return gradThickLineArrowBoth(this, px, py, qx, qy, thick, color1, color2, hasHit);
	}

	public inline function gradThickFixArrow(px:Float, py:Float, qx:Float, qy:Float, arrowWidth:Float, arrowHeight:Float, thick:Float, color1:Int, color2:Int,
			flare:Bool = false, reverseFlare:Bool = false, hasHit:Bool = true):Null<HitTriArray> {
		return gradThickLineFixedArrow(this, px, py, qx, qy, arrowWidth, arrowHeight, thick, color1, color2, flare, reverseFlare, hasHit);
	}

	public inline function gradThickFixArrowBoth(px:Float, py:Float, qx:Float, qy:Float, arrowWidth:Float, arrowHeight:Float, thick:Float, color1:Int,
			color2:Int, hasHit:Bool = true):Null<HitTriArray> {
	...
	**/
	public inline function fillEllipseTri(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0, ?printSides:Bool = false,
	...
	public inline function softFillEllipseTri(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, phi:Float = 0, softC:Float = 10, printSides:Bool = false,
			targetError:Float = 1.05) {
		var rSmall = (rx > ry) ? ry : rx;
		var noSides = circleError(rSmall, targetError);
		if (printSides)
	...
	public inline function tileEllipseTri(cx:Float, cy:Float, rx:Float, ry:Float, tileImage:Pixelimage, ?phi:Float = 0, ?printSides:Bool = false,
			?targetError:Float = 1.05) {
		var rSmall = (rx > ry) ? ry : rx;
		var noSides = circleError(rSmall, targetError);
		if (printSides)
	...
	**/
	public inline function lineEllipseTri(cx:Float, cy:Float, rx:Float, ry:Float, drx:Float, dry:Float, color:Int, ?phi:Float = 0, ?printSides:Bool = false,
			?targetError:Float = 1.05) {
		var rSmall = (rx > ry) ? ry : rx;
		...
		if (printSides)
			trace(noSides);
		var temp = (phi == 0) ? new Pixelshape(Std.int(2 * rx), Std.int(2 * ry)) : new Pixelshape(Std.int(2 * rLarge + rDif), Std.int(2 * rLarge + rDif));
		temp.transparent = false;
		if (phi == 0) {
	...
	**/
	public inline function fillRadialEllipseTri(cx:Float, cy:Float, rx:Float, ry:Float, colorIn:Int, colorOut:Int, gx:Float = 0., gy:Float = 0.,
	...
	**/
	public inline function lineRadialEllipseTri(cx:Float, cy:Float, rx:Float, ry:Float, drx:Float, dry:Float, colorIn:Int, colorOut:Int, gx:Float = 0.,
			gy:Float = 0., ?phi:Float = 0, ?printSides:Bool = false, ?targetError:Float = 1.05) {
		var rSmall = (rx > ry) ? ry : rx;
		var rLarge = (rx < ry) ? ry : rx;
		var rDif = rLarge - rSmall;
		var noSides = circleError(rSmall, targetError);
	...
	**/
	public inline function fillRadialRectangle(x:Float, y:Float, wid:Float, hi:Float, colorIn:Pixel32, colorOut:Pixel32, ?gx:Float = 0, ?gy:Float = 0) {
		var temp = new Pixelshape(Math.ceil(wid), Math.ceil(hi));
		var rx = wid / 2;
		var ry = hi / 2;
	...
	**/
	inline public function fillQuadrant(cx:Float, cy:Float, rx:Float, ry:Float, startAngle:Float, color:Int, ?phi:Float, ?targetError:Float = 1.05) {
	...
	**/
	inline public function tileQuadrant(cx:Float, cy:Float, rx:Float, ry:Float, startAngle:Float, tileImage:Pixelimage, ?phi:Float,
			?targetError:Float = 1.05) {
	...
	**/
	inline public function fillPolyBuild(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0., ?sides:Int = 36, cornerUp:Bool = true) {
		fillPolygonBuild(this, cx, cy, rx, ry, color, phi, sides, cornerUp);
	}

	inline public function softFillPolyBuild(cx:Float, cy:Float, rx:Float, ry:Float, color:Int, ?phi:Float = 0., ?sides:Int = 36, softC:Float = 10.,
			cornerUp:Bool = true) {
	...
	/**
		...
		cornerUp may need debugging
	**/
	inline public function tilePolyBuild(cx:Float, cy:Float, rx:Float, ry:Float, tileImage:Pixelimage, ?phi:Float = 0., ?sides:Int = 36,
			cornerUp:Bool = true) {
	...
	**/
	inline public function fillRadialPolyon(cx:Float, cy:Float, rx:Float, ry:Float, colorIn:Int, colorOut:Int, gx:Float = 0., gy:Float = 0., ?phi:Float = 0.,
