...
HX_DEFINE_STACK_FRAME(_hx_pos_08aeb8aedffe2afe_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/home/nanjizalmac/haxe/versions/4.3.3/std/sys/thread/EventLoop.hx",278,0xd41400cf)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_08aeb8aedffe2afe_278_new)
